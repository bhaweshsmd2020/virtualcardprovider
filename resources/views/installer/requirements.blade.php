...
@endphp
<div class="col-sm-12">
   <h3 class="text-center">🎉 {{ __('Welcome to Web Installer') }}</h3>
   <table class="header table table-hover mt-3">
    <tr>
      ...
      <tr>
         <td><h4>{{ __('PHP  8.2') }}</h4></td>
         <td class="text-right">
           <i class="fas {{ PHP_VERSION >= 8.2 ? 'fas fa-check text-success' : 'fas fa-times text-danger'  }}"></i> 
        </td>
     </tr>

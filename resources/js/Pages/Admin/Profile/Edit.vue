...
const updatePassword = () => {
  form.put(route('admin.profile.update', 'password'), {
    onSuccess: () => {
      toast.success(trans('Password Updated Successfully'), trans('Success'))
      form.reset()
    }
  })
}
const updateGeneral = () => {
  ...
  router.post(
    ...
    {
      onSuccess: () => {
        toast.success(trans('General Settings Updated Successfully'))
      }
    }
  )
}
              ...
              >
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                  <label class="label" for="first-name">
                    <span class="my-1 block">{{ trans('First Name') }}</span>
                    <input type="text" class="input" v-model="user.first_name" id="last-name" />
                  </label>
                  <label class="label" for="last-name">
                    <span class="my-1 block">{{ trans('Last Name') }}</span>
                    <input type="text" class="input" v-model="user.last_name" id="last-name" />
                  </label>
              ...
              <form method="post" class="-mt-1.5 flex w-full flex-col space-y-3">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    class="input"
                    value="https://www.instagram.com/1234"
                    name="instagram"
                    id="instagram"
                  />
                </div>

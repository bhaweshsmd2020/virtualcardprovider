<template>
  <main class="container p-4 sm:p-6">
    <Head title="Storage" />
    <PageHeader :title="trans('Storage Settings')" :buttons="buttons" />
    <div class="space-y-6">

                    ...
                    <ul class="dropdown-list">
                      <li class="dropdown-list-item">
                        <Link :href="route('admin.menu.show', menu.id)" class="dropdown-link">
                          <Icon class="h-6 text-slate-400" icon="bx:bx-list-plus" />
  ...
  <div id="addNewMenuDrawer" class="drawer drawer-right">
    <form @submit.prevent="storeMenu()">
      ...
      <div class="drawer-body">
        <div>
          <label class="mb-1 label label-required">{{ trans('Menu Name') }}</label>
          <input
            type="text"
            v-model="form.name"
            name="name"
        ...
        <div>
          <label class="mb-1 label label-required">{{ trans('Select Menu Position') }}</label>
        ...
        <div>
          <label class="mb-1 label label-required">{{ trans('Select Language') }}</label>
        ...
        <div>
          <label class="mb-1 label label-required">{{ trans('Menu Status') }}</label>

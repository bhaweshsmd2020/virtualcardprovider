...
const updateOrder = () => {
  form.put(route('admin.top-up.update', props.order.id), {
    onSuccess: () => {
...
<template>
  <main class="container flex-grow p-4 sm:p-6">
    <PageHeader title="Topup Details" />
        ...
        <div class="min-w-[38rem]">
          ...
          <div class="mt-4 flex items-stretch justify-between">
            <div>
              ...
              <p class="my-2 py-0 text-sm font-semibold">
                {{ trans('Topup To') }}:
                <span class="font-normal capitalize">{{ order?.type || 'Balance' }}</span>
              </p>
              <div class="">
    ...
    <div class="card mt-4">
      ...
      <div v-if="order.status === 'pending'">
        <form @submit.prevent="updateOrder">
          <div class="card-body flex items-end space-x-2 pt-0">
            <div>

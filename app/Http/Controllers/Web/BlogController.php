...
class BlogController extends Controller
{
    ...
    public function show(Post $blog)
    {
        ...
        $recent_blogs = Post::where('type', 'blog')->where('lang', app()->getLocale())->with('preview')->where('status', 1)->latest()->take(3)->get();
    ...
    public function category(Request $request, $slug)
    {
        ...
        $seo = SeoMeta::set([
            ...
            'description' => trans('Explore, Engage, and Enlighten: Your Gateway to Inspiring Blogs!')
        ]);

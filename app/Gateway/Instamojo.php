...
class Instamojo {
    ...
    public static function make_payment($array)
    {
        ...
        if ($array['phone'] == "") {
            return redirect()->back()->with('danger',__('Phone Number not given!'));
        }
        if (!preg_match($regex, $array['phone'])) {
            return redirect()->back()->with('danger',__('The phone number should be indian!'));
        }
        ...
        if(isset($response['payment_request'])) {
            ...
            return Inertia::location(Instamojo::redirect_if_payment_faild());
    ...
    public function status()
    {
        ...
        if ($response['payment_status']=='Credit') {
             ...
             return Inertia::location(Instamojo::redirect_if_payment_success());

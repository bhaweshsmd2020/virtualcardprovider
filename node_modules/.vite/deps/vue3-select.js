...
import {
  ...
  withDirectives,
  withModifiers
} from "./chunk-FUWNI6WI.js";
import "./chunk-2LSFTFF7.js";

// node_modules/vue3-select/dist/vue3-select.es.js
...
var k = (e, t, s) => t in e ? x(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var p = (e, t) => {
  for (var s in t || (t = {}))
    j.call(t, s) && k(e, s, t[s]);
  if (A)
    for (var s of A(t))
      K.call(t, s) && k(e, s, t[s]);
  return e;
};
var O = (e, t) => I(e, N(t));
var U = {
  ...
  methods: {
    ...
    typeAheadToLastSelected() {
      ...
      if (this.filteredOptions[0] && typeof this.filteredOptions[0] == "object") {
        const t = this.label, s = this.filteredOptions.map((n) => n[t]).indexOf((e = this.selectedValue[this.selectedValue.length - 1]) == null ? void 0 : e[t]);
...
function oe(e, t) {
  return openBlock(), createElementBlock("svg", te, ie);
}
var ne = L(ee, [["render", oe]]);
var M = {
  Deselect: W,
  OpenIndicator: ne
};
var le = {
  mounted(e, { instance: t }) {
    if (t.appendToBody) {
      const { height: s, top: n, left: l, width: i } = t.$refs.toggle.getBoundingClientRect();
      let m = window.scrollX || window.pageXOffset, b = window.scrollY || window.pageYOffset;
...
var ce = {
  components: p({}, M),
  directives: { appendToBody: le, clickOutside: ae },
  mixins: [U, q, J],
  compatConfig: {
    MODE: 3
  },
    ...
    getOptionKey: {
      ...
      default(e) {
        if (typeof e != "object")
          return e;
        try {
          return e.hasOwnProperty("id") ? e.id : re(e);
        } catch (t) {
...
https://vue-select.org/api/props.html#getoptionkey`, e, t);
  ...
  methods: {
    clickOutside() {
      this.open && !this.searchable && (this.open = false);
    },
    /**
    ...
    toggleDropdown(e) {
      ...
      this.open && t ? this.searchEl.blur() : this.open && !t && !this.searchable ? this.open = false : this.disabled || (this.open = true, this.searchEl.focus());
    },
    /**
     ...
     */
    onSearchBlur() {
      if (this.open = false, this.mousedown && !this.searching)
...
var ue = ["dir"];
var pe = ["id", "aria-expanded", "aria-owns", "aria-label"];
var fe = {
  ref: "selectedOptions",
  class: "vs__selected-options"
};
var ge = ["disabled", "title", "aria-label", "onClick"];
var ye = {
  ref: "actions",
  class: "vs__actions"
};
var me = ["disabled"];
var be = { class: "vs__spinner" };
var Oe = ["id"];
var _e = ["id", "aria-selected", "onMouseover", "onClick", "onTouchstart"];
var ve = {
  key: 0,
  class: ""
};
...
function Ve(e, t, s, n, l, i) {
  const m = resolveDirective("click-outside"), b = resolveDirective("append-to-body");
  return openBlock(), createElementBlock("div", {
    ...
    withDirectives((openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", fe, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(i.selectedValue, (o, u) => renderSlot(e.$slots, "selected-option-container", {
        ...
        renderSlot(e.$slots, "search", normalizeProps(guardReactiveProps(i.scope.search)), () => [
          createBaseVNode("input", mergeProps({ class: "vs__search" }, i.scope.search.attributes, toHandlers(i.scope.search.events, true)), null, 16)
        ])
      ], 512),
      createBaseVNode("div", ye, [
        ...
        renderSlot(e.$slots, "spinner", normalizeProps(guardReactiveProps(i.scope.spinner)), () => [
          withDirectives(createBaseVNode("div", be, "Loading...", 512), [
    ...
    createVNode(Transition, { name: s.transition }, {
      default: withCtx(() => [
        i.dropdownOpen ? withDirectives((openBlock(), createElementBlock("ul", {
          ...
          role: "listbox",
          tabindex: "-1",
          onMousedown: t[3] || (t[3] = withModifiers((...o) => i.onMousedown && i.onMousedown(...o), ["prevent"])),
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(i.filteredOptions, (o, u) => (openBlock(), createElementBlock("li", {
            ...
            class: normalizeClass({
              ...
              "vs__dropdown-option--deselect": i.isOptionDeselectable(o) && u === e.typeAheadPointer,
              "vs__dropdown-option--selected": i.isOptionSelected(o),
              "vs__dropdown-option--highlight": !i.isOptGroupOption(o) && u === e.typeAheadPointer || i.isOptionSelected(o),
              "vs__dropdown-option--disabled": !s.selectable(o)
            }),
            "aria-selected": u === e.typeAheadPointer ? true : null,
            onMouseover: (g) => s.selectable(o) ? e.updateTypeAheadPointer(u) : null,
            onMouseout: t[2] || (t[2] = (g) => e.updateTypeAheadPointer(-1)),
            onClick: withModifiers((g) => s.selectable(o) ? i.select(o) : null, ["prevent", "stop"]),
            onTouchstart: (g) => s.selectable(o) ? e.updateTypeAheadPointer(u) : null
          }, [
            o.optgroup ? (openBlock(), createElementBlock("div", ve, toDisplayString(o.optgroup), 1)) : renderSlot(e.$slots, "option", normalizeProps(mergeProps({ key: 1 }, i.normalizeOptionForSlot(o))), () => [
              createTextVNode(toDisplayString(s.getOptionLabel(o)), 1)
            ])
          ], 42, _e))), 128)),
          i.filteredOptions.length === 0 ? (openBlock(), createElementBlock("li", we, [
            renderSlot(e.$slots, "no-options", normalizeProps(guardReactiveProps(i.scope.noOptions)), () => [
              createTextVNode(" Sorry, no matching options. ")
            ])

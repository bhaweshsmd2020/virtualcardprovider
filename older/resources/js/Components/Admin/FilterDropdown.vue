...
const handleSubmit = () => {
  ...
  filterForm.get(url + queryString)
}
...
<template>
  <div class="flex items-stretch justify-end gap-x-2">
      ...
      <div class="dropdown-content w-72 !overflow-visible">
        <form @submit.prevent="handleSubmit">
          <ul class="dropdown-list space-y-4 p-4">
            ...
            <li
              v-if="isOptionExist && isOptionExist.options"
            ...
            <li class="dropdown-list-item">
              ...
              <select
                class="select"
                @change="filterForm.reset('search')"
            ...
            <li class="dropdown-list-item">
              <SpinnerBtn
                :disabled="filterForm.search.length === 0"
                type="submit"
    ...
    <button
      ...
      @click="clearFilter"
      @mouseover="showClearText = true"
      @mouseout="showClearText = false"
      class="btn flex items-center border bg-gray-300 dark:bg-gray-700"
      title="clear filter"
    >
      <i class="bx bx-x"></i>

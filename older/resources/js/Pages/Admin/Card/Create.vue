...
const props = defineProps(['categories', 'merchantCategories', 'card_variants'])
      ...
      <form @submit.prevent="submit" class="space-y-5">
        <div class="card card-body">
          ...
          <div class="mb-2">
            ...
            <input v-model="form.min_deposit" type="number" name="title" required class="input" />
          </div>
          <div class="mb-2">
        ...
        <div class="card card-body">
          ...
          <div class="mb-4 space-y-2">
            ...
            <p v-if="form.category_type" class="pt-2 text-sm text-red-600">
              *{{ trans('Selected category will be') }} {{ form.category_type }}
              {{ trans('for payment') }}.
            </p>

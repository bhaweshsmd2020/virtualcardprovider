...
const props = defineProps(['buttons', 'service', 'categories'])
...
const submit = () => {
  form.post(route('admin.services.update', props.service), {
    onSuccess: () => {
      form.reset()
    }
  })
...
<template>
  <main class="container p-4 sm:p-6">
    <PageHeader title="Edit Service" :buttons="buttons" />
      ...
      <div class="card-body">
        <form @submit.prevent="submit">
          ...
          <div class="mb-2 mt-3">
            ...
            <textarea v-model="form.overview" class="input"></textarea>

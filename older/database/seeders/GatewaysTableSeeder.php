...
class GatewaysTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $gateways = array(
            ...
            array('id' => '6', 'name' => 'instamojo', 'currency' => 'inr', 'logo' => '/demo/instamojo.png', 'charge' => '2', 'multiply' => '1', 'namespace' => 'App\\Gateway\\Instamojo', 'min_amount' => '1', 'max_amount' => '1000', 'is_auto' => '1', 'image_accept' => '0', 'test_mode' => '1', 'status' => '1', 'phone_required' => '1', 'log_enabled' => '0', 'data' => '{"x_api_key":"1","x_auth_token":"s"}', 'comment' => 'sdfgsdfg', 'created_at' => '2024-04-03 03:44:01', 'updated_at' => '2024-04-15 05:16:11'),
